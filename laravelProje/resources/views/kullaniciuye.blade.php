...
<div class="container">
  ...
  <form action="kullaniciuye.blade.php" method="post">
...
<div class="signin">
  <p>Zaten bir hesabınız var mı? <a href="kullaniciasci.blade.php">Giriş Yap</a>.</p>
</div>
...
if(isset($_POST["name"],$_POST["surname"],$_POST["email"],$_POST["psw"]))
{
  ...
  if($baglan-> query($ekle)===TRUE)
  {
    ...
    header("Location: website.blade.php"); // Anasayfaya yönlendir
    exit;
  }
