...
<h1>Kullanıcı Giriş</h1>
  <form action="website.blade.php" method="post">
    ...
    <br>
  Eğer üye değilseniz <a href="kullaniciuye.blade.php">Üye olunuz</a>
</form>
<a href="sifreyenilekullanici.blade.php">Şifremi unuttum</a>
</div>
...
if(isset($_POST["email"], $_POST["psw"])) {
    ...
    if ($sonuc->num_rows > 0) {
        ...
        if (hash_equals($hashli_sifre, $user['sifre'])) {
            ...
            header("Location: website.blade.php");
            exit;
        } else {
            // Şifre yanlış
